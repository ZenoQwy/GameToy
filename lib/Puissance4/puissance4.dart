            ...
            child: ClipRRect(
              ...
              child: Container(
                color: Color.fromRGBO(
                    0, 100, 255, 1), // Fond vert pour grille du morpion
                width: MediaQuery.of(context).size.width *
                    1, // Largeur de la grille
                height: MediaQuery.of(context).size.height *
                    0.80, // Hauteur de la grille
                child: Column(
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                  shape:
                                      CircleBorder(), // Définir la forme du bouton en cercle
                                  primary: _partie
                                              .getPlateau()
                                              .getcase(row, col)
                                              .getvaleur() ==
